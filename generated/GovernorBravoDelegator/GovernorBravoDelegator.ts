...
export class ProposalVotingStarted extends ethereum.Event {
  get params(): ProposalVotingStarted__Params {
    return new ProposalVotingStarted__Params(this);
  }
}

export class ProposalVotingStarted__Params {
  _event: ProposalVotingStarted;

  constructor(event: ProposalVotingStarted) {
    this._event = event;
  }
...
export class GovernorBravoDelegator extends ethereum.SmartContract {
  static bind(address: Address): GovernorBravoDelegator {
    return new GovernorBravoDelegator("GovernorBravoDelegator", address);
  }
...
export class ConstructorCall__Inputs {
  ...
  get activationGracePeriod_(): BigInt {
